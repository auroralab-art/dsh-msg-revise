...
- Conversation-body control is the text button **修改**. Confirm is **重新发送**. Cancel is **取消**.
- Works on the open tail (in-flight or just-aborted) and on settled user turns.
